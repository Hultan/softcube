...
func (c *Cube) updateColors() {
	...
	c.cubits[0].U.Col = getColor(str[0])
	c.cubits[1].U.Col = getColor(str[1])
	c.cubits[2].U.Col = getColor(str[2])
	c.cubits[9].U.Col = getColor(str[3])
	c.cubits[10].U.Col = getColor(str[4])
	c.cubits[11].U.Col = getColor(str[5])
	c.cubits[18].U.Col = getColor(str[6])
	c.cubits[19].U.Col = getColor(str[7])
	c.cubits[20].U.Col = getColor(str[8])

	// Green (front) side (on a solved cube)
	...
	c.cubits[5].R.Col = getColor(str[19])
	c.cubits[8].R.Col = getColor(str[20])
	c.cubits[11].R.Col = getColor(str[21])
	c.cubits[14].R.Col = getColor(str[22])
	c.cubits[17].R.Col = getColor(str[23])
	c.cubits[20].R.Col = getColor(str[24])
	c.cubits[23].R.Col = getColor(str[25])
	c.cubits[26].R.Col = getColor(str[26])

	// Blue (back) side (on a solved cube)
	c.cubits[18].F.Col = getColor(str[27])
	c.cubits[19].F.Col = getColor(str[28])
	c.cubits[20].F.Col = getColor(str[29])
	c.cubits[21].F.Col = getColor(str[30])
	c.cubits[22].F.Col = getColor(str[31])
	c.cubits[23].F.Col = getColor(str[32])
	c.cubits[24].F.Col = getColor(str[33])
	c.cubits[25].F.Col = getColor(str[34])
	c.cubits[26].F.Col = getColor(str[35])

	// Orange (left) side (on a solved cube)
	c.cubits[0].L.Col = getColor(str[36])
	c.cubits[3].L.Col = getColor(str[37])
	c.cubits[6].L.Col = getColor(str[38])
	c.cubits[9].L.Col = getColor(str[39])
	c.cubits[12].L.Col = getColor(str[40])
	c.cubits[15].L.Col = getColor(str[41])
	c.cubits[18].L.Col = getColor(str[42])
	c.cubits[21].L.Col = getColor(str[43])
	c.cubits[24].L.Col = getColor(str[44])
